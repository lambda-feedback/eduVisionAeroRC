...
def evaluation_function(
    ...
    def analyze_images(images):
        ...
        for idx, image in enumerate(images):
            try:
                ...
                per_image_best.append({"best_det": None, "chose_from_center": False})
                continue
    ...
    if response_detection:
        ...
        overall_name = response[overall_best_image_idx].get("name", f"image_{overall_best_image_idx}.jpg")
        ...
        feedback_items.append(("Overall Best", "No components detected in any image."))

    
    # --- combined link + detection text ---
    for idx, (img, detections, best_idx) in enumerate(annotated_images):
        ...
        feedback_items.append((f"Image [{idx}]", combined))
